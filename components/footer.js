...
function Footer({ check,check1 }) {
  return (
    <>
      {!check && !check1 && (
        <div className="pb-5  bg-orange-100">
          <footer className="px-4 py-14 bg-orange-100 mt-20 sm:px-20 sm:py-10 ">
            <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
                ...
                <p className="my-5 md:w-96">
                  ...
                  by like-minded, enthusiastic experts.
                </p>
              </div>
